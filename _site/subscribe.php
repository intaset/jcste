...
<script>
  (function() {
    var cx = '016656741306535874023:jnjjbyngwri';
...
$confirmed = 0;
 ...
 // now we insert it into the database
  ...
  $subject = "Journal of Civil, Structural and Transportation Engineering (JCSTE)"; 
  $message = "Thank you for signing up to receive alerts for JCSTE - Journal of Civil, Structural and Transportation Engineering.
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <p class="body">Thank you for subscribing to JCSTE - Journal of Civil, Structural and Transportation Engineering. A confirmation email has been sent to your email. Please click on the confirmation link available in the email to confirm your subscription.</p>
